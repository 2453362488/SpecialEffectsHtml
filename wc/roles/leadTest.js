(function() {
    function Lead() {
        ...
        function draw() {
            ...
            var img1=document.getElementById("tpImg1");
            var img2=document.getElementById("tpImg2");
            ...
            // draw body
            ctx.beginPath();
            ctx.drawImage(img1,leadInfo.position.x, leadInfo.position.y,24,24);
            ctx.fill();
            // draw mouse
            ctx.beginPath();
            if (mouseIsRect) {
                ...
                ctx.drawImage(img2,leadInfo.position.x, leadInfo.position.y,24,24);
                ctx.fill();
            }
        }
